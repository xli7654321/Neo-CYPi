...
class Ui_singlePage(object):
    def setupUi(self, singlePage):
        ...
        sizePolicy.setHeightForWidth(self.single_scrollArea.sizePolicy().hasHeightForWidth())
        self.single_scrollArea.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.single_scrollAreaWidgetContents.sizePolicy().hasHeightForWidth())
        self.single_scrollAreaWidgetContents.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.single_icon.sizePolicy().hasHeightForWidth())
        self.single_icon.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.single_label.sizePolicy().hasHeightForWidth())
        self.single_label.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.single_input_label.sizePolicy().hasHeightForWidth())
        self.single_input_label.setSizePolicy(sizePolicy1)
        font2 = QFont()
        font2.setFamilies([u"Segoe UI"])
        font2.setPointSize(13)
        self.single_input_label.setFont(font2)
        self.single_input_label.setCursor(QCursor(Qt.IBeamCursor))
        self.single_input_label.setTextInteractionFlags(Qt.LinksAccessibleByMouse|Qt.TextSelectableByMouse)
        ...
        sizePolicy2.setHeightForWidth(self.single_table.sizePolicy().hasHeightForWidth())
        self.single_table.setSizePolicy(sizePolicy2)
