...
class Ui_aboutPage(object):
    ...
    def retranslateUi(self, aboutPage):
        ...
        self.about_title_label.setText(QCoreApplication.translate("aboutPage", u"Neo-CYPi", None))
        self.version_label.setText(QCoreApplication.translate("aboutPage", u"Version 1.0", None))
        self.intro_label.setText(QCoreApplication.translate("aboutPage", u"<html><head/><body><p><span style=\" font-weight:600;\">Neo-CYPi</span> is an open-source software specifically designed for predicting potential inhibitors of Cytochrome P450 enzymes based on our existing best models.</p></body></html>", None))
        ...
        self.license_label.setText(QCoreApplication.translate("aboutPage", u"<html><head/><body><p><span style=\" font-weight:600;\">License</span>: This software is powered by the PySide6 library (LGPLv3) and is released under the BSD 3-Clause License. Please see <a href=\"https://github.com/xli7654321/Neo-CYPi\"><span style=\" text-decoration: underline; color:#1cbf70;\">https://github.com/xli7654321/Neo-CYPi</span></a> for more details.</p></body></html>", None))
