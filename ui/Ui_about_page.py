...
class Ui_aboutPage(object):
    ...
    def retranslateUi(self, aboutPage):
        ...
        self.about_title_label.setText(QCoreApplication.translate("aboutPage", u"NEXT-CYPInh", None))
        self.version_label.setText(QCoreApplication.translate("aboutPage", u"Version 1.0", None))
        self.intro_label.setText(QCoreApplication.translate("aboutPage", u"<html><head/><body><p><span style=\" font-weight:600;\">NEXT-CYPInh</span> is an open-source software specifically designed for predicting potential inhibitors of Cytochrome P450 enzymes based on our existing best models.</p></body></html>", None))
        self.copy_label.setText(QCoreApplication.translate("aboutPage", u"Copyright &copy; 2025 Laboratory of Molecular Modeling and Design, School of Pharmacy, East China University of Science and Technology. All rights reserved.", None))
        self.license_label.setText(QCoreApplication.translate("aboutPage", u"<html><head/><body><p><span style=\" font-weight:600;\">License</span>: This software is powered by the PySide6 library (LGPLv3) and is released under the BSD 3-Clause License. Please see <a href=\"https://github.com/xli7654321/NEXT-CYPInh\"><span style=\" text-decoration: underline; color:#1cbf70;\">https://github.com/xli7654321/NEXT-CYPInh</span></a> for more details.</p></body></html>", None))
        self.contact_label.setText(QCoreApplication.translate("aboutPage", u"<html><head/><body><p>Contact us: <a href=\"xli3667@mail.ecust.edu.cn\"><span style=\" text-decoration: underline; color:#1cbf70;\">Xiang Li</span></a> and <a href=\"whli@ecust.edu.cn\"><span style=\" text-decoration: underline; color:#1cbf70;\">Prof. Weihua Li</span></a>. See <a href=\"https://lmmd.ecust.edu.cn/\"><span style=\" text-decoration: underline; color:#1cbf70;\">LMMD</span></a> for more information about our laboratory.</p></body></html>", None))
        self.thanks_label.setText(QCoreApplication.translate("aboutPage", u"<html><head/><body><p>We gratefully acknowledge scikit-learn, RDKit, and DeepChem, which made this software possible.</p></body></html>", None))
